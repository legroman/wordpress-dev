...
$(document).ready(function () {
  var width = document.querySelector('.header__left-side').offsetWidth;
  ...
  $('.team__specialists img').on('click', function () {
    $(this).parent().children('.team__list').slideToggle("slow", function () {// Animation complete.
    });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktemplate_html"] = self["webpackChunktemplate_html"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/app"], () => (__webpack_require__("./src/js/script.js")))
